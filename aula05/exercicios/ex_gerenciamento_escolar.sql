-- 01) Atividade: Alterando os dados (UPDATE)
--     Estude como utilizar o comando UPDATE para modificar registros
--     existentes em uma tabela no SQLite.
...
-- 02) Atividade: Atualizando dados
--     Pratique atualizações em colunas específicas, aplicando condições
--     através do WHERE.
...
-- 03) Atividade: Deletando os dados (DELETE)
--     Compreenda como remover registros de uma tabela usando DELETE,
--     incluindo cuidados com o uso sem WHERE.
